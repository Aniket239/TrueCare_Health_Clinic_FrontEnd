...
import '../styles/departments.css';  // Ensure you have a corresponding CSS file for styling
        ...
        <div className="departments-container">
            ...
            <div className="hero-section">
                <div className="hero-text">
                    <h1>Departments</h1>
                    <p>Your health is our priority. Explore our specialized departments.</p>
                </div>
            </div>
            ...
            <div className="departments-list">
                <ul>
                    {departmentList.map((departments, index) => (
                        <li key={index} className="departments-card">
                            <div className="departments-card-image">
                                <img src={departments.image} alt={departments.name} />
                            </div>
